...
The image tag is configurable in `.env`. Watchtower updates are disabled so the application and its dependencies can be updated together. See the [monitoring guide](../../../docs/project-guides/monitoring.md) for lifecycle and backup guidance.
